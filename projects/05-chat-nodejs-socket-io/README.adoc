...
É necessário instalar o http://nodejs.org:[Node.js] para rodar o servidor e o http://npmjs.com:[npm] para gerenciar pacotes utilizados pela aplicação (como por exemplo, baixar tais pacotes diretamente pelo terminal).
